...
class TrackRepository(metaclass=ABCMeta):
    ...
    def get_track_by_id(self, track_id: str) -> Optional[Track]:
        ...
        Returns:
            Optional[Track]: Track object with the specifed track_id
        """
        pass
    ...
    def get_tracks_by_ids(self, track_ids: List[str]) -> Optional[List[Track]]:
        ...
        Returns:
            Optional[List[Track]]: list of Track objects with the specifed ids
        """
        pass
    ...
    def get_tracks_by_query(self, query: str) -> Optional[List[Track]]:
        ...
        Returns:
            Optional[List[Track]]: list of Track objects related to the specifed query
        """
        pass
