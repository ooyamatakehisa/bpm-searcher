...
class PlaylistRepositoryImpl(PlaylistRepository):
    ...
    def get_playlist_infos(self, uid: str) -> List[PlaylistInfo]:
        ...
        in_exp = PlaylistInfoDataModel.id.in_(plalist_ids)
    ...
    def get_playlist_track(self, playlist_track_id: str) -> PlaylistTrack:
        try:
    ...
    def save_playlist_info(self, playlist_info: PlaylistInfo):
        try:
